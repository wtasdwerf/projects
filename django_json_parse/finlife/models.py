...
class DepositProducts(models.Model):
    ...
    join_deny = models.IntegerField()     # 가입제한(1: 제한 없음, 2 : 서민 전용, 3 일부제한)
...
class DepositOptions(models.Model):
    product = models.ForeignKey("DepositProducts", on_delete=models.CASCADE, related_name='depositproducts')   # depositproducts 참조 외래키
